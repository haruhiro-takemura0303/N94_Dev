...
#define BOARD_INITPINS_ALERT_GPIO GPIO5               /*!<@brief GPIO peripheral base pointer */
#define BOARD_INITPINS_ALERT_GPIO_PIN 7U              /*!<@brief GPIO pin number */
#define BOARD_INITPINS_ALERT_GPIO_PIN_MASK (1U << 7U) /*!<@brief GPIO pin mask */

/* Symbols to be used with PORT driver */
#define BOARD_INITPINS_ALERT_PORT PORT5               /*!<@brief PORT peripheral base pointer */
#define BOARD_INITPINS_ALERT_PIN 7U                   /*!<@brief PORT pin number */
#define BOARD_INITPINS_ALERT_PIN_MASK (1U << 7U)      /*!<@brief PORT pin mask */
                                                      /* @} */
