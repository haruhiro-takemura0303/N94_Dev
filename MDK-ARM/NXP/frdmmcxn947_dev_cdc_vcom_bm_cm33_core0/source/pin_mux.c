...
board: FRDM-MCXN947
pin_labels:
- {pin_num: L13, pin_signal: PIO5_7/TRIG_IN11/TAMPER5/ADC1_B15, label: 'P5_7/J5[2]', identifier: INT;ALERT}
...
- pin_list:
  ...
  - {pin_num: L13, peripheral: GPIO5, signal: 'GPIO, 7', pin_signal: PIO5_7/TRIG_IN11/TAMPER5/ADC1_B15, identifier: ALERT, direction: INPUT, gpio_per_interrupt: kGPIO_InterruptFallingEdge,
...
void BOARD_InitPins(void)
{
    ...
    /* Interrupt configuration on GPIO5_7 (pin L13): Interrupt on falling edge */
    GPIO_SetPinInterruptConfig(BOARD_INITPINS_ALERT_GPIO, BOARD_INITPINS_ALERT_PIN, kGPIO_InterruptFallingEdge);
