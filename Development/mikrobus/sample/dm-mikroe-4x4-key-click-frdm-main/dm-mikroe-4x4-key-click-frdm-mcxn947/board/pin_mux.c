...
static PORT_Type const* s_ports [] = PORT_BASE_PTRS;
static const clock_ip_name_t s_port_clocks []= {kCLOCK_Port0,
		kCLOCK_Port1,
		kCLOCK_Port2,
		kCLOCK_Port3,
		kCLOCK_Port4
...
static const clock_ip_name_t s_gpio_clocks []= GPIO_CLOCKS;
...
void BOARD_InitSpiCs()
{
    const port_pin_config_t gpio = {/* Internal pull-up/down resistor is disabled */
                                                    kPORT_PullDisable,
                                                    /* Low internal pull resistor value is selected. */
                                                    kPORT_LowPullResistor,
                                                    /* Fast slew rate is configured */
	...
	CLOCK_EnableClock(s_port_clocks[KEYCLIK_CS_GPIO_PORT	]);
	CLOCK_EnableClock(s_gpio_clocks[KEYCLIK_CS_GPIO_PORT	]);
	PORT_SetPinConfig((PORT_Type*)(s_ports[KEYCLIK_CS_GPIO_PORT	]), KEYCLIK_CS_GPIO_PIN, &gpio);
}
...
void LPSPI6_InitPins(void)
{
    ...
    PORT_SetPinConfig(PORT3, 20U, &port0_24_pinB6_config);
    ...
    PORT_SetPinConfig(PORT3, 21U, &port0_25_pinA6_config);
    ...
    PORT_SetPinConfig(PORT3, 22U, &port0_26_pinF10_config);
    ...
    const port_pin_config_t port0_27_pinE10_config = {/* Internal pull-up resistor is enabled */
                                                      ...
                                                      /* Pin Control Register fields [15:0] are not locked */
                                                      kPORT_UnlockRegister};
    /* PORT0_27 (pin E10) is configured as GPIO */
    PORT_SetPinConfig(PORT3, 23U, &port0_27_pinE10_config);
}
