...
__ALIGNED(4)
#endif
/*static*/ const uint8_t stDeviceQualifierDescriptor[] = {
    USB_DEVICEQUALDESC_SIZE,    /*bLength*/
    DESCTYPE_DEVICE_QUALIFIER,  /*bDescriptorType*/
    WORDLB(USB_HS_VER),         /*bcdUSB*/
    WORDHB(USB_HS_VER),         
    USB_CLASS_MISC,             /*bDeviceClass*/
    USB_SUBCLASS_MISC_COMMON,   /*bDeviceSubClass*/
...
__ALIGNED(4)
#endif
/*static*/ const uint8_t stOtherSpeedConfigurationDescriptor[] = {
    /*Other Speed Configuration Descriptor*/
    USB_OTHERSPDCONFIGDESC_SIZE,        /*bLength*/
    DESCTYPE_OTHERSPD_CONFIG,           /*bDescriptorType*/
    WORDLB(USB_CONFIGDESC_FULLSIZE),    /*wTotalLength*/
    WORDHB(USB_CONFIGDESC_FULLSIZE),    
    USB_NUMOF_IF,                       /*bNumInterfaces*/
    USB_CONFIG_VALUE,                   /*bConfigurationValue*/
    ...
    USB_CDC0_DATAOUTEP_ADDR,            /*bEndpointAddress*/
    USB_CDC_DATAEP_ATTR,                /*bmAttributes*/
    WORDLB(USB_CDC_DATAEP_FS_MPS),      /*wMaxPacketSize*/
    WORDHB(USB_CDC_DATAEP_FS_MPS),         
    USB_UNDEF,                          /*bInterval*/
...
int32_t UsbdDualVcom_InitDescriptor(void)
{
    ...
    Usbd_SetDescriptor(DESCTYPE_DEVICE_QUALIFIER, stDeviceQualifierDescriptor, sizeof(stDeviceQualifierDescriptor));
    Usbd_SetDescriptor(DESCTYPE_OTHERSPD_CONFIG, stOtherSpeedConfigurationDescriptor, sizeof(stOtherSpeedConfigurationDescriptor));
